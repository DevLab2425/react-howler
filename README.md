...
sprite    |         | An object representing an [audio sprite](https://github.com/goldfire/howler.js#define-and-play-a-sound-sprite).
spriteToPlay|       | A string which will be used to play the specific audio sprite part.
